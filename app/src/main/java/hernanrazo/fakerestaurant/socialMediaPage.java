...
public class socialMediaPage extends AppCompatActivity {
    ...
    private void addDrawerItems() {
        ...
        mDrawerList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if(position == 0) {
                    Intent homePageIntent = new Intent(socialMediaPage.this, homePage.class);
                    startActivity(homePageIntent);
                }
                else if (position == 1) {
                    Intent menuPageIntent = new Intent(socialMediaPage.this, menuPage.class);
                    ...
                    Intent reviewsPageIntent = new Intent(socialMediaPage.this, reviewsPage.class);
                    startActivity(reviewsPageIntent);
                }
                else if (position == 5) {
                    Intent socialMediaPageIntent = new Intent(socialMediaPage.this, socialMediaPage.class);
                    startActivity(socialMediaPageIntent);
                }
                else if (position == 6) {
                    Intent contactUsIntent = new Intent(socialMediaPage.this, contactUsPage.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_social_media_page);
